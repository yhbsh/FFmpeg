...
SUBDIR_VARS := CLEANFILES FFLIBS HEADERS ARCH_HEADERS BUILT_HEADER       \
               SKIPHEADERS ARMV5TE-OBJS ARMV6-OBJS ARMV8-OBJS VFP-OBJS   \
			   NEON-OBJS ALTIVEC-OBJS VSX-OBJS MMX-OBJS X86ASM-OBJS      \
               MIPSFPU-OBJS MIPSDSPR2-OBJS MIPSDSP-OBJS MSA-OBJS         \
               MMI-OBJS LSX-OBJS LASX-OBJS RV-OBJS RVV-OBJS RVVB-OBJS    \
               OBJS SLIBOBJS SHLIBOBJS STLIBOBJS
...
uninstall: uninstall-headers uninstall-libs uninstall-pkgconfig
...
.PHONY: all all-yes build check config
